...
public class ModifiedPlayerHandler implements Runnable{
    ...
    public static final List<ModifiedPlayerHandler> playerHandlers = new ArrayList<>();
    ...
    public ModifiedPlayerHandler(ModifiedServer server,Socket clientSocket,GameEngine gameEngine){
        try {
            this.server = server;
